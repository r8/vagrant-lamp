...
4. [Add tests for your changes](https://github.com/escapestudios-cookbooks/composer/blob/master/TESTING.md)
4. Push your changes to your feature branch (`git push origin my-new-feature`)
5. Create a new Pull Request (PR)

## Testing
Contributions will only be accepted if they are fully tested as specified in [TESTING.md](https://github.com/escapestudios-cookbooks/composer/blob/master/TESTING.md).
